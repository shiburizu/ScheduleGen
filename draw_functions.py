...
def draw_day_box(day, transform=f"translate({0}, {0})"):
    ...
    stream_day.append(draw.Rectangle(0, 0, obj_width, obj_height, stroke = "#FFD700", stroke_width = 1, fill = '#FFD700', shape_rendering="crispEdges"))
...
def draw_zone_name_box(zone_text,  transform=f"translate({0}, {0})"):
    ...
    stream_zone_text.append(draw.Rectangle(0,0,obj_width, obj_height, stroke = "#FFD700", stroke_width = 1, fill = '#FFD700',  shape_rendering="crispEdges"))
    stream_zone_text.append(draw.Text(zone_text, 12, obj_width/2, obj_height/2, center=True, fill="black", font_weight="bold", font_family="Poppins"))
...
def draw_offset_box(offset,  transform=f"translate({0}, {0})"):
    ...
    offset_box.append(draw.Rectangle(0,0, obj_width, obj_height, stroke = "#FFD700", stroke_width = .5, fill = '#FFD700', shape_rendering="crispEdges"))
...
def draw_stream_link(platform, streamer, transform=f"translate({0}, {0})"):
    ...
    border = draw.Rectangle(0,0, obj_width, obj_height, stroke = 'black', stroke_width = 1, fill="none",  shape_rendering="crispEdges")
    plat = draw.Text(platform, 10, obj_width/2, obj_height/4, fill='white', center=True, font_weight="bold", font_family="Poppins")
    link = draw.Text(streamer, 14, obj_width/2, 5*obj_height/8, fill='white', center=True, font_weight="bold", font_family="Poppins")
...
def draw_conversion_header(day, num_cells, transform=f"translate({0}, {0})"):
    ...
    text.append(draw.TSpan(" (" + days[prev_day].lower().capitalize() +" in gold, ", font_size="18",  fill="white", font_weight="bold", font_family="Poppins"))
...
def draw_cv_time_cell(time, transform=f"translate({0}, {0})"):
    ...
    obj_height = TIME_ZONE_ROW_HEIGHT * CELL_HEIGHT
    filled_cell = draw.Group(transform=transform)
    text = draw.Text(time, 12,  obj_width/10, obj_height - (obj_height/3), center=False, fill= "black", font_weight="bold", font_family="Poppins",  shape_rendering="crispEdges")
...
def draw_tourney_name(event,  transform=f"translate({0}, {0})"):
    ...
    bg = draw.Rectangle(0,0, obj_width, obj_height, fill="black", stroke = 'black', stroke_width = '1', shape_rendering="crispEdges")
    text1 = draw.Text(event['event']['title_line1'], 24, obj_width/2, obj_height * .4 , center = True, fill="white", font_weight="bold", font_family="Poppins")
    text2 = draw.Text(event['event']['title_line2'], 24, obj_width/2, obj_height * .6, center = True, fill="white", font_weight="bold", font_family="Poppins")
...
def draw_tourney_infobox(event, transform=f"translate({0}, {0})"):
    ...
    line1_text = draw.Text(event['event']['dates'], 18, obj_width/2, line_height/2 , center = True, fill="black", font_weight="bold", font_family="Poppins")
    line2_text = draw.Text(event['event']['location'], 18, obj_width/2, (line_height/2) + line_height , center = True, fill="black", font_weight="bold", font_family="Poppins")
    line3_str = event['event']['twitter'] + " | " + event['event']['hashtag']
    line3_text = draw.Text(line3_str, 18, obj_width/2, (line_height/2) + (2*line_height) , center = True, fill="black", font_weight="bold", font_family="Poppins")
...
def draw_disclaimer(event, transform=f"translate({0}, {0})"):
    ...
    warningBox = draw.Rectangle(0,0, obj_width, disc_height, fill = "#FFD700", stroke = 'black', stroke_width = '1', shape_rendering="crispEdges")
    warningText = draw.Text("ALL TIMES SUBJECT TO CHANGE", 22, obj_width/2, disc_height/2, center = True, fill="black", font_weight="bold", font_family="Poppins")
    ...
    line1 = draw.Text(line1_str, 15, obj_width/2, disc_height + .5*line_height, center = True, fill="black", font_family="Poppins",  font_weight="bold")
    line2 = draw.Text(line2_str, 15, obj_width/2, disc_height + 1.5 * line_height, center = True, fill="black", font_family="Poppins",  font_weight="bold")
    line3 = draw.Text(line3_str, 20, obj_width/2, disc_height + 2.5*line_height, center = True, fill="black", font_family="Poppins",  font_weight="bold")
...
def draw_time_desc(event, transform=f"translate({0}, {0})"):
    ...
    warningText = draw.Text(warning_str, 16, obj_width/2, disc_height/2, center = True, fill="black", font_weight="bold", font_family="Poppins")
    line1_bg = draw.Rectangle(0, disc_height, obj_width, line_height, fill = "white", stroke = "white", stroke_width = 1, shape_rendering="crispEdges")
    line2_bg = draw.Rectangle(0, disc_height + line_height, obj_width, line_height, fill = "white", stroke = "white", stroke_width = 1, shape_rendering="crispEdges")
    line3_bg = draw.Rectangle(0, disc_height + 2 * line_height, obj_width, line_height, fill = "white", stroke = "white", stroke_width = 1, shape_rendering="crispEdges")
    border = draw.Rectangle(0,0, obj_width, obj_height, fill="none", stroke = "black", stroke_width = 1, shape_rendering="crispEdges")
    ...
    line3_str = "at the bottom of each day's schedule."
    line1 = draw.Text(line1_str, 18, obj_width/2, disc_height + .5*line_height, center = True, fill="black", font_family="Poppins",  font_weight="bold")
    line2 = draw.Text(line2_str, 18, obj_width/2, disc_height + 1.5 * line_height, center = True, fill="black", font_family="Poppins",  font_weight="bold")
    line3 = draw.Text(line3_str, 18, obj_width/2, disc_height + 2.5*line_height, center = True, fill="black", font_family="Poppins",  font_weight="bold")
...
def draw_tournament_box(event, transform=f"translate({0}, {0})" ):
    ...
    logo = draw_tourney_logo(event['event']['tourney_logo'],transform=f"translate({BLEED_WIDTH * CELL_WIDTH}, {BLEED_HEIGHT * CELL_HEIGHT})")
